# Graph Report - security-scan-cli  (2026-05-27)

## Corpus Check
- 61 files · ~37,340 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 666 nodes · 961 edges · 49 communities (37 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5454a8fa`
...
2. `main()` - 19 edges
3. `run()` - 17 edges
4. `vulnscan — Architecture Overview` - 14 edges
5. `syncIfStale()` - 12 edges
6. `runScan()` - 12 edges
7. `ScanWarning` - 12 edges
8. `incomplete()` - 12 edges
9. `InMemoryAdvisoryStore` - 11 edges
10. `informational()` - 11 edges
...
Cohesion: 0.05
Nodes (49): SqliteAdvisoryStore, normalizeRawRange(), advisory, advisory2, findings, lodashAdvisory, malAdvisory, multiRangeAdvisory (+41 more)

### Community 1 - "CLI Args & Scan Pipeline"
Cohesion: 0.09
Nodes (42): openStore(), matchAffected(), bootstrapDb(), maybeBootstrap(), resolveAssetUrl(), parseArgs(), computeExitCode(), getFailOn() (+34 more)
...
Cohesion: 0.08
Nodes (24): openDb(), safeAddColumn(), advisories, after, before, database, dbPath, expectedOrder (+16 more)
...
Cohesion: 0.11
Nodes (14): eventsToRanges(), { advisories }, [arg], arrayBufferSpy, baseAffected, buf, { db }, { db, transactionWrapper } (+6 more)

### Community 14 - "Arg Parser Core"
Cohesion: 0.11
Nodes (11): cancelFn, malwareItem, mockFetch, reviewedItem, since, start, store, types (+3 more)
...
Cohesion: 0.12
Nodes (16): [0.0.1] — initial release, [0.1.0] — 2026-05-27, [0.1.1] — 2026-05-27, [0.2.0] — 2026-05-27, [0.2.1] — 2026-05-27, [0.2.2] — 2026-05-27, Breaking changes, Bug fixes (+8 more)

### Community 17 - "Args Tests"
Cohesion: 0.13
Nodes (6): InMemoryAdvisoryStore, advisories, advisory, first, results, second
...
## Knowledge Gaps
- **365 isolated node(s):** `HelpTopic`, `ParsedArgs`, `KNOWN_FLAGS`, `KNOWN_BOOLEAN_FLAGS`, `KNOWN_COMMANDS` (+360 more)
...
- **Why does `run()` connect `CLI Args & Scan Pipeline` to `CLI Entry & Architecture Docs`, `Advisory Database Layer`, `Ancestry Builder`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `InMemoryAdvisoryStore` connect `Args Tests` to `CLI Entry & Architecture Docs`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `openDb()` connect `Output Rendering` to `CLI Entry & Architecture Docs`, `CLI Args & Scan Pipeline`, `Sync Test Helpers`?**
